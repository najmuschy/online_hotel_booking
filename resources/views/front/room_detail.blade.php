        ...
        <div class="row">
            <div class="col-lg-8 col-md-7 col-sm-12 left">
                ...
                <div class="room-detail-carousel owl-carousel">
                    <div class="item" style="background-image:url({{ asset('uploads/'.$room_detail_data->featured_photo) }});">
                        <div class="bg"></div>
                    </div>
                    @foreach ($room_detail_data->rRoomPhoto as $item)
                ...
                <div class="amenity">
                    ...
                    <div class="row">
                        @php
                        $arr = explode(',',$room_detail_data->amenities);
            ...
            @if($room_detail_data->video_id!=0)
                <div class="video">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/{{ $room_detail_data->video_id }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            @endif
