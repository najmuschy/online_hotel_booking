...
class AdminPageController extends Controller
{
    ...
    public function photo(){
        $page_data = Page::where('id',1)->first() ;
        return view('admin.page_photo', compact('page_data')) ;
    }
    ...
    public function photo_update(Request $request){
        ...
        $obj->photo_heading = $request->photo_heading;
        $obj->photo_status = $request->photo_status;
    ...
    public function video(){
        $page_data = Page::where('id',1)->first() ;
        return view('admin.page_video', compact('page_data')) ;
    }
    ...
    public function video_update(Request $request){
        ...
        $obj->video_heading = $request->video_heading;
