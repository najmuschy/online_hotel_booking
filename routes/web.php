...
//Customer Login and SignUp(In Hotel Front Page)
...
//Customer with Middleware(Customer Panel)
...
Route::get('/admin/reset-password/{email}/{token}', [AdminLoginController::class, 'reset_password'])->name('admin_reset_password');
...
Route::group(['middleware', ['admin:admin']], function () {
    ...
    //Admin Panel Testimonial Section
    ...
    Route::get('/admin/page/photo', [AdminPageController::class, 'photo'])->name('admin_page_photo');
    Route::post('/admin/page/photo/update', [AdminPageController::class, 'photo_update'])->name('admin_page_photo_update');

    Route::get('/admin/page/video', [AdminPageController::class, 'video'])->name('admin_page_video');
    Route::post('/admin/page/video/update', [AdminPageController::class, 'video_update'])->name('admin_page_video_update');
    ...
    Route::get('/admin/subscriber/view', [AdminSubscriberController::class, 'show'])->name('admin_subscriber_show');
    ...
    //Admin Rooms Section
    Route::get('/admin/amenities/view', [AdminAmenityController::class, 'index'])->name('admin_amenities_view');
    Route::get('/admin/amenities/add', [AdminAmenityController::class, 'add'])->name('admin_amenities_add');
    Route::post('/admin/amenities/store', [AdminAmenityController::class, 'store'])->name('admin_amenities_store');
    Route::get('/admin/amenities/edit/{id}', [AdminAmenityController::class, 'edit'])->name('admin_amenities_edit');
    Route::post('/admin/amenities/update/{id}', [AdminAmenityController::class, 'update'])->name('admin_amenities_update');
    Route::get('/admin/amenities/delete/{id}', [AdminAmenityController::class, 'delete'])->name('admin_amenities_delete');
